...
export const metadata: Metadata = {
  title: "Alterar Senha | Estoque Soviético",
};

const errorMessages: Record<string, string> = {
  tamanho: "A nova senha precisa ter pelo menos 10 caracteres.",
  confirmacao: "A confirmação não corresponde à nova senha.",
  conta: "Não foi possível localizar esta conta no banco.",
};
        ...
        >
          ...
          {erro && (
            <p className="rounded-none border-4 border-[#1A1A1A] bg-[#A91D11] p-3 font-mono text-xs font-black uppercase text-white">
              {errorMessages[erro] ?? "Não foi possível alterar a senha."}
            </p>
          )}
